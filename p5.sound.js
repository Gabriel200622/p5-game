...
(function (modules) {
        ...
        (a.prototype.defaultArg = function (t, e) {
          if (this.isObject(t) && this.isObject(e)) {
            var n,
              o,
              i = {};
            for (n in t) i[n] = this.defaultArg(e[n], t[n]);
            for (o in e) i[o] = this.defaultArg(t[o], e[o]);
            return i;
          }
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    (function (global) {
      ...
      var startaudiocontext__WEBPACK_IMPORTED_MODULE_0___default =
        __webpack_require__.n(startaudiocontext__WEBPACK_IMPORTED_MODULE_0__);
      var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
      var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1___default =
        __webpack_require__.n(Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__);
      var Tone_core_Context__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(12);
      var Tone_core_Context__WEBPACK_IMPORTED_MODULE_2___default =
        __webpack_require__.n(Tone_core_Context__WEBPACK_IMPORTED_MODULE_2__);
  ...
  function (module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (r) {
      "use strict";
      return (
        (r.TimelineSignal = function () {
          var e = this.optionsObject(
            arguments,
            ["value", "units"],
            r.Signal.defaults
          );
          (this._events = new r.Timeline(10)),
            r.Signal.apply(this, e),
            (e.param = this._param),
            r.Param.call(this, e),
            (this._initial = this._fromUnits(this._param.value));
        }),
        r.extend(r.TimelineSignal, r.Param),
        (r.TimelineSignal.Type = {
          Linear: "linear",
        ...
        Object.defineProperty(r.TimelineSignal.prototype, "value", {
          get: function () {
            var e = this.now(),
              e = this.getValueAtTime(e);
        ...
        (r.TimelineSignal.prototype.setValueAtTime = function (e, t) {
          return (
            (e = this._fromUnits(e)),
            (t = this.toSeconds(t)),
            this._events.add({
              type: r.TimelineSignal.Type.Set,
              value: e,
              time: t,
            }),
        ...
        (r.TimelineSignal.prototype.linearRampToValueAtTime = function (e, t) {
          return (
            (e = this._fromUnits(e)),
            (t = this.toSeconds(t)),
            this._events.add({
              type: r.TimelineSignal.Type.Linear,
              value: e,
              time: t,
            }),
        ...
        (r.TimelineSignal.prototype.exponentialRampToValueAtTime = function (
          e,
          t
        ) {
          t = this.toSeconds(t);
          var i = this._searchBefore(t),
            i =
              ...
              (e = this._fromUnits(e)),
              Math.max(e, this._minOutput));
          return (
            this._events.add({
              type: r.TimelineSignal.Type.Exponential,
              value: i,
              time: t,
            }),
            e < this._minOutput
        ...
        (r.TimelineSignal.prototype.setTargetAtTime = function (e, t, i) {
          return (
            (e = this._fromUnits(e)),
            ...
            (t = this.toSeconds(t)),
            this._events.add({
              type: r.TimelineSignal.Type.Target,
              value: e,
              time: t,
              constant: i,
            }),
        ...
        (r.TimelineSignal.prototype.setValueCurveAtTime = function (
          e,
          t,
          i,
          n
          ...
          (t = this.toSeconds(t)),
            (i = this.toSeconds(i)),
            this._events.add({
              type: r.TimelineSignal.Type.Curve,
              value: a,
              time: t,
              duration: i,
            }),
          ...
          for (var s = 1; s < a.length; s++) {
            var o = t + (s / (a.length - 1)) * i;
            this._param.linearRampToValueAtTime(a[s], o);
          }
          return this;
        }),
        (r.TimelineSignal.prototype.cancelScheduledValues = function (e) {
          return (
            (e = this.toSeconds(e)),
        ...
        (r.TimelineSignal.prototype.setRampPoint = function (e) {
          e = this.toSeconds(e);
          ...
          return (
            i && i.time === e
              ...
              : i &&
                i.type === r.TimelineSignal.Type.Curve &&
                i.time + i.duration > e
              ? (this.cancelScheduledValues(e),
                this.linearRampToValueAtTime(t, e))
              : ((i = this._searchAfter(e)) &&
                  (this.cancelScheduledValues(e),
                  i.type === r.TimelineSignal.Type.Linear
                    ? this.linearRampToValueAtTime(t, e)
                    : i.type === r.TimelineSignal.Type.Exponential &&
                      this.exponentialRampToValueAtTime(t, e)),
                this.setValueAtTime(t, e)),
            this
          );
        }),
        (r.TimelineSignal.prototype.linearRampToValueBetween = function (
          e,
          t,
          i
        ) {
        ...
        (r.TimelineSignal.prototype.exponentialRampToValueBetween = function (
          e,
          t,
          i
        ) {
        ...
        (r.TimelineSignal.prototype._searchBefore = function (e) {
          return this._events.get(e);
        }),
        (r.TimelineSignal.prototype._searchAfter = function (e) {
          return this._events.getAfter(e);
        }),
        (r.TimelineSignal.prototype.getValueAtTime = function (e) {
          e = this.toSeconds(e);
          var t,
            i = this._searchAfter(e),
          ...
          return null === n
            ? this._initial
            : n.type === r.TimelineSignal.Type.Target
            ? ((t =
                null === (t = this._events.getBefore(n.time))
                  ? this._initial
                  : t.value),
              this._exponentialApproach(n.time, t, n.value, n.constant, e))
            : n.type === r.TimelineSignal.Type.Curve
        ...
        (r.TimelineSignal.prototype.connect = r.SignalBase.prototype.connect),
        (r.TimelineSignal.prototype._exponentialApproach = function (
          e,
          t,
          i,
          n,
        ...
        (r.TimelineSignal.prototype._linearInterpolate = function (
          e,
          t,
          i,
          n,
        ...
        (r.TimelineSignal.prototype._exponentialInterpolate = function (
          e,
          t,
          i,
          n,
        ...
        (r.TimelineSignal.prototype._curveInterpolate = function (e, t, i, n) {
          var a,
            l = t.length;
          return e + i <= n
            ? t[l - 1]
            ...
            : ((n = (n - e) / i),
              ...
              (a = t[e]),
              (t = t[i]),
              i === e ? a : this._linearInterpolate(e, a, i, t, n * (l - 1)));
        }),
        (r.TimelineSignal.prototype.dispose = function () {
          r.Signal.prototype.dispose.call(this),
            r.Param.prototype.dispose.call(this),
      ...
      return (
        (s.Clock = function () {
          ...
          (this.callback = t.callback),
            (this._nextTick = 0),
            (this._lastState = s.State.Stopped),
            (this.frequency = new s.TimelineSignal(
              t.frequency,
              s.Type.Frequency
            )),
            this._readOnly("frequency"),
            (this.ticks = 0),
            (this._state = new s.TimelineState(s.State.Stopped)),
            (this._boundLoop = this._loop.bind(this)),
            this.context.on("tick", this._boundLoop);
        }),
        s.extend(s.Clock, s.Emitter),
        (s.Clock.defaults = {
          callback: s.noOp,
          frequency: 1,
          lookAhead: "auto",
        }),
        Object.defineProperty(s.Clock.prototype, "state", {
          get: function () {
            return this._state.getValueAtTime(this.now());
          },
        }),
        (s.Clock.prototype.start = function (t, e) {
          return (
            (t = this.toSeconds(t)),
            this._state.getValueAtTime(t) !== s.State.Started &&
              this._state.add({ state: s.State.Started, time: t, offset: e }),
            this
          );
        }),
        (s.Clock.prototype.stop = function (t) {
          return (
            (t = this.toSeconds(t)),
            this._state.cancel(t),
            this._state.setStateAtTime(s.State.Stopped, t),
            this
          );
        }),
        (s.Clock.prototype.pause = function (t) {
          return (
            (t = this.toSeconds(t)),
            this._state.getValueAtTime(t) === s.State.Started &&
              this._state.setStateAtTime(s.State.Paused, t),
            this
          );
        }),
        (s.Clock.prototype._loop = function () {
          for (
            var t =
              this.now() +
            ...
            var e = this._state.getValueAtTime(this._nextTick),
              i =
                (e !== this._lastState &&
                  ((this._lastState = e),
                  (i = this._state.get(this._nextTick)),
                  e === s.State.Started
                    ...
                    : e === s.State.Paused && this.emit("pause", i.time)),
                this._nextTick);
            this.frequency &&
              ((this._nextTick +=
        ...
        (s.Clock.prototype.getStateAtTime = function (t) {
          return (t = this.toSeconds(t)), this._state.getValueAtTime(t);
        }),
        (s.Clock.prototype.dispose = function () {
          s.Emitter.prototype.dispose.call(this),
  ...
  function (module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (r) {
      function t() {
        var o = AudioNode.prototype.connect,
          i = AudioNode.prototype.disconnect;
        function t(e, t, n) {
          if (e.input)
            Array.isArray(e.input)
              ? (r.prototype.isUndef(n) && (n = 0), this.connect(e.input[n]))
      ...
      return (
        ...
        (r.Context = function (t) {
          for (var e in (r.Emitter.call(this),
        ...
        r.extend(r.Context, r.Emitter),
        r.Emitter.mixin(r.Context),
        (r.Context.prototype._defineProperty = function (e, n) {
          this.isUndef(this[n]) &&
        ...
        (r.Context.prototype.now = function () {
          return this._context.currentTime;
        }),
        (r.Context.prototype._createWorker = function () {
          ...
          return (
            ...
            t.addEventListener(
              ...
              function () {
                var t,
                  e = this.now();
                this.isNumber(this._lastUpdate) &&
                  ((t = e - this._lastUpdate),
        ...
        (r.Context.prototype.getConstant = function (t) {
        ...
        Object.defineProperty(r.Context.prototype, "lag", {
          get: function () {
            var t = this._computedUpdateInterval - this._updateInterval;
            return Math.max(t, 0);
          },
        }),
        Object.defineProperty(r.Context.prototype, "lookAhead", {
          get: function () {
        ...
        Object.defineProperty(r.Context.prototype, "updateInterval", {
          get: function () {
            return this._updateInterval;
          },
          set: function (t) {
            (this._updateInterval = Math.max(t, r.prototype.blockTime)),
              this._worker.postMessage(Math.max(1e3 * t, 1));
          },
        }),
        Object.defineProperty(r.Context.prototype, "latencyHint", {
          get: function () {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
      return (
        ...
        (o.Time.prototype.toNotation = function () {
          ...
          return t.split("+").length < e.split("+").length ? t : e;
        }),
        ...
        (o.Time.prototype.toBarsBeatsSixteenths = function () {
          var t = this._beatsToUnits(1),
            ...
            e = (t % 1) * 4;
          return [
            Math.floor(t / this._timeSignature()),
            Math.floor(t) % this._timeSignature(),
            (e = 3 < (e = e.toString()).length ? parseFloat(e).toFixed(3) : e),
          ].join(":");
        }),
      ...
      return (
        (n.TimeBase = function (e, t) {
          ...
          (this._expr = this._noOp),
            e instanceof n.TimeBase
              ? this.copy(e)
              : !this.isUndef(t) || this.isNumber(e)
              ? ((t = this.defaultArg(t, this._defaultUnits)),
                (t = this._primaryExpressions[t].method),
                (this._expr = t.bind(this, e)))
              : this.isString(e)
              ? this.set(e)
        ...
        (n.TimeBase.prototype._matchGroup = function (e, t, r) {
          if (!this.isUndef(e))
            for (var n in t) {
              n = t[n];
              if (n.regexp.test(e.value)) {
                if (this.isUndef(r)) return n;
                if (n.precedence === r) return n;
              }
            }
          return !1;
        }),
        ...
        (n.TimeBase.prototype._parseUnary = function (e) {
          var t,
            r = e.peek(),
            r = this._matchGroup(r, this._unaryExpressions);
          return r
            ? (e.next(), (t = this._parseUnary(e)), r.method.bind(this, t))
        ...
        (n.TimeBase.prototype._parsePrimary = function (e) {
          ...
          if (this._matchGroup(t, this._primaryExpressions))
            return (
              (r = (t = e.next()).value.match(t.regexp)),
              t.method.bind(this, r[1], r[2], r[3])
            );
          if (t && "(" === t.value) {
            if (
              (e.next(),
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (a) {
      ...
      return (
        ...
        Object.defineProperty(a.Param.prototype, "value", {
          ...
          set: function (t) {
            if (this.isObject(t)) {
              ...
              t = this._fromUnits(t);
              this._param.cancelScheduledValues(0), (this._param.value = t);
            }
          },
        }),
        ...
        (a.Param.prototype._toUnits = function (t) {
          return (!this.convert && !this.isUndef(this.convert)) ||
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (i) {
      ...
      return (
        ...
        (i.Timeline.prototype.add = function (e) {
          ...
          return (
            this._timeline.length
              ? ((i = this._search(e.time)), this._timeline.splice(i + 1, 0, e))
        ...
        (i.Timeline.prototype.remove = function (e) {
          return (
            this._iterating
              ...
              : -1 !== (e = this._timeline.indexOf(e)) &&
                this._timeline.splice(e, 1),
            this
          );
        }),
        ...
        (i.Timeline.prototype.getBefore = function (e) {
          ...
          return (0 < i && this._timeline[i - 1].time < e) ||
            0 <= (i = this._search(e)) - 1
            ? this._timeline[i - 1]
            : null;
        }),
        ...
        (i.Timeline.prototype._search = function (e) {
          ...
          for (; i < n; ) {
            ...
            if (h.time < e && s.time > e) return r;
            h.time > e ? (n = r) : h.time < e && (i = r + 1);
          }
          return -1;
        }),
        (i.Timeline.prototype._iterate = function (e, i, t) {
          ...
          if (((this._iterating = !1), 0 < this._toRemove.length)) {
            for (var r = 0; r < this._toRemove.length; r++) {
              var h = this._timeline.indexOf(this._toRemove[r]);
              -1 !== h && this._timeline.splice(h, 1);
            }
            this._toRemove = [];
          }
        }),
        ...
        (i.Timeline.prototype.forEachBefore = function (e, i) {
          e = this._search(e);
          return -1 !== e && this._iterate(i, 0, e), this;
        }),
        (i.Timeline.prototype.forEachAfter = function (e, i) {
          e = this._search(e);
          return this._iterate(i, e + 1), this;
        }),
    ...
    !(function (e, t) {
      ...
      function o(t, n) {
        (i(t)
          ? n
          : function e() {
              i(t) ? n() : (requestAnimationFrame(e), t.resume && t.resume());
            })();
      }
      return (
        ...
        (r.prototype._ended = function (e) {
          var t, n;
          this._dragged ||
            ((t = (e = e).createBuffer(1, 1, e.sampleRate)),
            ((n = e.createBufferSource()).buffer = t),
          ...
          return (
            (function e(t, n, i) {
              ...
              if (Array.isArray(t) || (NodeList && t instanceof NodeList))
                for (var o = 0; o < t.length; o++) e(t[o], n, i);
              else
                "string" == typeof t
                  ? e(document.querySelectorAll(t), n, i)
                  : t.jquery && "function" == typeof t.toArray
                  ? e(t.toArray(), n, i)
                  : Element &&
                    t instanceof Element &&
                    ((d = new r(t, i)), n.push(d));
  ...
  function (module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (r) {
      (r.Frequency = function (e, t) {
        if (!(this instanceof r.Frequency)) return new r.Frequency(e, t);
        r.TimeBase.call(this, e, t);
      }),
        ...
        (r.Frequency.prototype._primaryExpressions.note = {
          ...
          method: function (e, t) {
            e = n[e.toLowerCase()] + 12 * (parseInt(t) + 1);
            return this.midiToFrequency(e);
          },
        }),
        ...
        (r.Frequency.prototype.transpose = function (e) {
          return (
        ...
        (r.Frequency.prototype.harmonize = function (e) {
          return (
            (this._expr = function (e, t) {
        ...
        (r.Frequency.prototype.toNote = function () {
          var e = this.valueOf(),
            e = Math.log(e / r.Frequency.A4) / Math.LN2,
            e = Math.round(12 * e) + 57,
            t = Math.floor(e / 12);
          return t < 0 && (e += -12 * t), o[e % 12] + t.toString();
        }),
        ...
        (r.Frequency.prototype._frequencyToUnits = function (e) {
          return e;
        }),
        (r.Frequency.prototype._ticksToUnits = function (e) {
          return 1 / ((60 * e) / (r.Transport.bpm.value * r.Transport.PPQ));
        }),
        (r.Frequency.prototype._beatsToUnits = function (e) {
          return 1 / r.TimeBase.prototype._beatsToUnits.call(this, e);
        }),
        (r.Frequency.prototype._secondsToUnits = function (e) {
          return 1 / e;
        }),
      ...
      return (
        (r.Frequency.A4 = 440),
        (r.Frequency.prototype.midiToFrequency = function (e) {
          return r.Frequency.A4 * Math.pow(2, (e - 69) / 12);
        }),
        (r.Frequency.prototype.frequencyToMidi = function (e) {
          return 69 + (12 * Math.log(e / r.Frequency.A4)) / Math.LN2;
        }),
        r.Frequency
      );
    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)),
  ...
  function (module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (e) {
      return (
        (e.TransportTime = function (t, r) {
          if (!(this instanceof e.TransportTime))
            return new e.TransportTime(t, r);
          e.Time.call(this, t, r);
        }),
        e.extend(e.TransportTime, e.Time),
        (e.TransportTime.prototype._unaryExpressions = Object.create(
          e.Time.prototype._unaryExpressions
        )),
        (e.TransportTime.prototype._unaryExpressions.quantize = {
          regexp: /^@/,
          method: function (t) {
            var t = this._secondsToTicks(t()),
              r = Math.ceil(e.Transport.ticks / t);
            return this._ticksToUnits(r * t);
          },
        }),
        (e.TransportTime.prototype._secondsToTicks = function (t) {
          var r = this._beatsToUnits(1);
          return Math.round((t / r) * e.Transport.PPQ);
        }),
        (e.TransportTime.prototype.valueOf = function () {
          return (
            this._secondsToTicks(this._expr()) +
            (this._plusNow ? e.Transport.ticks : 0)
          );
        }),
        (e.TransportTime.prototype.toTicks = function () {
          return this.valueOf();
        }),
        (e.TransportTime.prototype.toSeconds = function () {
          return this._expr() + (this._plusNow ? e.Transport.seconds : 0);
        }),
        (e.TransportTime.prototype.toFrequency = function () {
          return 1 / this.toSeconds();
        }),
        e.TransportTime
      );
  ...
  function (module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (u) {
      "use strict";
      function r(e, n, r) {
        e = new e();
        return (
          r._eval(n[0]).connect(e, 0, 0), r._eval(n[1]).connect(e, 0, 1), e
        );
      }
      function t(e, n, r) {
        e = new e();
        return r._eval(n[0]).connect(e, 0, 0), e;
      }
      function o(e) {
      ...
      return (
        ...
        (u.Expr._Expressions = {
          ...
          func: {
            abs: { regexp: /^abs/, method: t.bind(this, u.Abs) },
            mod: {
              regexp: /^mod/,
              method: function (e, n) {
                var r = i(e[1]),
            ...
            a2g: {
              regexp: /^a2g/,
              method: function (e, n) {
                var r = new u.AudioToGain();
                return n._eval(e[0]).connect(r), r;
              },
            },
          },
          binary: {
            "+": { regexp: /^\+/, precedence: 1, method: r.bind(this, u.Add) },
            "-": {
              regexp: /^\-/,
              precedence: 1,
              method: function (e, n) {
                return 1 === e.length ? t(u.Negate, e, n) : r(u.Subtract, e, n);
              },
            },
            "*": {
              regexp: /^\*/,
              precedence: 0,
              method: r.bind(this, u.Multiply),
            },
          },
          unary: {
            "-": { regexp: /^\-/, method: t.bind(this, u.Negate) },
            "!": { regexp: /^\!/, method: t.bind(this, u.NOT) },
          },
        }),
        (u.Expr.prototype._parseInputs = function (e) {
          var n = e.match(/\$\d/g),
            r = 0;
          if (null !== n)
            for (var t = 0; t < n.length; t++)
              var o = parseInt(n[t].substr(1)) + 1, r = Math.max(r, o);
          return r;
        }),
        (u.Expr.prototype._replacements = function (e) {
          for (var n = e.shift(), r = 0; r < e.length; r++)
            n = n.replace(/\%/i, e[r]);
          return n;
        }),
        (u.Expr.prototype._tokenize = function (e) {
          for (var n = -1, r = []; 0 < e.length; ) {
            var t = (function (e) {
              for (var n in u.Expr._Expressions) {
                var r,
                  t = u.Expr._Expressions[n];
                for (r in t) {
                  var o = t[r],
                    i = o.regexp,
                    i = e.match(i);
                  if (null !== i)
                    return { type: n, value: i[0], method: o.method };
                }
              }
        ...
        (u.Expr.prototype._parseTree = function (e) {
          var t = this._tokenize(e),
            i = this.isUndef.bind(this);
          function o(e, n) {
            return !i(e) && "glue" === e.type && e.value === n;
          }
          function a(e, n, r) {
            var t = u.Expr._Expressions[n];
            if (!i(e))
              for (var o in t) {
                o = t[o];
                if (o.regexp.test(e.value)) {
                  if (i(r)) return 1;
                  if (o.precedence === r) return 1;
                }
              }
          }
          function s(e) {
            n =
              (e = i(e) ? 5 : e) < 0
                ...
                : s(e - 1);
            for (var n, r = t.peek(); a(r, "binary", e); )
              (n = {
          ...
          function p() {
            ...
            if ("func" === e.type) {
              ...
              if (!o(t.next(), "("))
                throw new SyntaxError(
                  'Tone.Expr: Expected ( in a function call "' + n.value + '"'
                );
              if (
                (o(t.peek(), ")") ||
                  (r = (function () {
                ...
                return { method: n.method, args: r, name: name };
              throw new SyntaxError(
                'Tone.Expr: Expected ) in a function call "' + n.value + '"'
              );
            }
            ...
            if (o(e, "(")) {
              if ((t.next(), (r = s()), o((e = t.next()), ")"))) return r;
              throw new SyntaxError("Expected )");
            }
            throw new SyntaxError(
        ...
        (u.Expr.prototype._eval = function (e) {
          if (!this.isUndef(e))
            return (e = e.method(e.args, this)), this._nodes.push(e), e;
        }),
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    function loadAudioWorkletModules() {
      return Promise.all(
        moduleSources.map(function (moduleSrc) {
          ...
          return audioWorklet_ac.audioWorklet
            .addModule(objectURL)
            ["catch"](function () {
    ...
    function effect_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          effect_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function effect_toPropertyKey(arg) {
      var key = effect_toPrimitive(arg, "string");
      return effect_typeof(key) === "symbol" ? key : String(key);
    }
    function effect_toPrimitive(input, hint) {
      if (effect_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (effect_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function panner_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          panner_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function panner_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        panner_defineProperties(Constructor.prototype, protoProps);
      if (staticProps) panner_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function panner_toPropertyKey(arg) {
      var key = panner_toPrimitive(arg, "string");
      return panner_typeof(key) === "symbol" ? key : String(key);
    }
    function panner_toPrimitive(input, hint) {
      if (panner_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (panner_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function _possibleConstructorReturn(self, call) {
      if (
        call &&
        (panner_typeof(call) === "object" || typeof call === "function")
      ) {
        return call;
      } else if (call !== void 0) {
        throw new TypeError(
      ...
      var Panner = (function (_Effect) {
        ...
        panner_createClass(Panner, [
          ...
          },
          {
            key: "dispose",
            value: function dispose() {
              _get(_getPrototypeOf(Panner.prototype), "dispose", this).call(
                this
              );
      ...
      var _Panner = (function (_Effect2) {
        ...
        panner_createClass(_Panner, [
          ...
          },
          {
            key: "dispose",
            value: function dispose() {
              _get(_getPrototypeOf(_Panner.prototype), "dispose", this).call(
                this
              );
              if (this.left) {
    ...
    function soundfile_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          soundfile_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function soundfile_toPropertyKey(arg) {
      var key = soundfile_toPrimitive(arg, "string");
      return soundfile_typeof(key) === "symbol" ? key : String(key);
    }
    function soundfile_toPrimitive(input, hint) {
      if (soundfile_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (soundfile_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function amplitude_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          amplitude_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function amplitude_toPropertyKey(arg) {
      var key = amplitude_toPrimitive(arg, "string");
      return amplitude_typeof(key) === "symbol" ? key : String(key);
    }
    function amplitude_toPrimitive(input, hint) {
      if (amplitude_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (amplitude_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function fft_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          fft_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function fft_toPropertyKey(arg) {
      var key = fft_toPrimitive(arg, "string");
      return fft_typeof(key) === "symbol" ? key : String(key);
    }
    function fft_toPrimitive(input, hint) {
      if (fft_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (fft_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function oscillator_inherits(subClass, superClass) {
      if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError(
          "Super expression must either be null or a function"
        );
      ...
      Object.defineProperty(subClass, "prototype", { writable: false });
      if (superClass) oscillator_setPrototypeOf(subClass, superClass);
    }
    function oscillator_setPrototypeOf(o, p) {
      oscillator_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
          };
      return oscillator_setPrototypeOf(o, p);
    }
    function oscillator_createSuper(Derived) {
      var hasNativeReflectConstruct = oscillator_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = oscillator_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = oscillator_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return oscillator_possibleConstructorReturn(this, result);
      };
    }
    function oscillator_possibleConstructorReturn(self, call) {
      if (
        call &&
      ...
      return oscillator_assertThisInitialized(self);
    }
    function oscillator_assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError(
          "this hasn't been initialised - super() hasn't been called"
        );
    ...
    function oscillator_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function oscillator_getPrototypeOf(o) {
      oscillator_getPrototypeOf = Object.setPrototypeOf
        ? Object.getPrototypeOf.bind()
        : function _getPrototypeOf(o) {
            return o.__proto__ || Object.getPrototypeOf(o);
          };
      return oscillator_getPrototypeOf(o);
    }
    ...
    function oscillator_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          oscillator_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function oscillator_toPropertyKey(arg) {
      var key = oscillator_toPrimitive(arg, "string");
      return oscillator_typeof(key) === "symbol" ? key : String(key);
    }
    function oscillator_toPrimitive(input, hint) {
      if (oscillator_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (oscillator_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function envelope_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function envelope_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          envelope_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function envelope_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        envelope_defineProperties(Constructor.prototype, protoProps);
      if (staticProps) envelope_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function envelope_toPropertyKey(arg) {
      var key = envelope_toPrimitive(arg, "string");
      return envelope_typeof(key) === "symbol" ? key : String(key);
    }
    function envelope_toPrimitive(input, hint) {
      if (envelope_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (envelope_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function noise_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          noise_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function noise_toPropertyKey(arg) {
      var key = noise_toPrimitive(arg, "string");
      return noise_typeof(key) === "symbol" ? key : String(key);
    }
    function noise_toPrimitive(input, hint) {
      if (noise_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (noise_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function noise_setPrototypeOf(o, p) {
      noise_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function noise_createSuper(Derived) {
      var hasNativeReflectConstruct = noise_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = noise_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = noise_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return noise_possibleConstructorReturn(this, result);
      };
    }
    ...
    function noise_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function pulse_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          pulse_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function pulse_toPropertyKey(arg) {
      var key = pulse_toPrimitive(arg, "string");
      return pulse_typeof(key) === "symbol" ? key : String(key);
    }
    function pulse_toPrimitive(input, hint) {
      if (pulse_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (pulse_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function pulse_setPrototypeOf(o, p) {
      pulse_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function pulse_createSuper(Derived) {
      var hasNativeReflectConstruct = pulse_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = pulse_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = pulse_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return pulse_possibleConstructorReturn(this, result);
      };
    }
    ...
    function pulse_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function audioin_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          audioin_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function audioin_toPropertyKey(arg) {
      var key = audioin_toPrimitive(arg, "string");
      return audioin_typeof(key) === "symbol" ? key : String(key);
    }
    function audioin_toPrimitive(input, hint) {
      if (audioin_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (audioin_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function filter_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          filter_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function filter_toPropertyKey(arg) {
      var key = filter_toPrimitive(arg, "string");
      return filter_typeof(key) === "symbol" ? key : String(key);
    }
    function filter_toPrimitive(input, hint) {
      if (filter_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (filter_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function filter_setPrototypeOf(o, p) {
      filter_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function filter_createSuper(Derived) {
      ...
      return function _createSuperInternal() {
        var Super = filter_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = filter_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return filter_possibleConstructorReturn(this, result);
      };
    }
    ...
    function eqFilter_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          eqFilter_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function eqFilter_toPropertyKey(arg) {
      var key = eqFilter_toPrimitive(arg, "string");
      return eqFilter_typeof(key) === "symbol" ? key : String(key);
    }
    function eqFilter_toPrimitive(input, hint) {
      if (eqFilter_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (eqFilter_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function eqFilter_setPrototypeOf(o, p) {
      eqFilter_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function eqFilter_createSuper(Derived) {
      var hasNativeReflectConstruct = eqFilter_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = eqFilter_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = eqFilter_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return eqFilter_possibleConstructorReturn(this, result);
      };
    }
    ...
    function eqFilter_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function eq_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          eq_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function eq_toPropertyKey(arg) {
      var key = eq_toPrimitive(arg, "string");
      return eq_typeof(key) === "symbol" ? key : String(key);
    }
    function eq_toPrimitive(input, hint) {
      if (eq_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (eq_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function eq_get() {
      ...
      return eq_get.apply(this, arguments);
    }
    ...
    function eq_setPrototypeOf(o, p) {
      eq_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function eq_createSuper(Derived) {
      var hasNativeReflectConstruct = eq_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = eq_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = eq_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return eq_possibleConstructorReturn(this, result);
      };
    }
    ...
    function eq_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    var eq = eq_EQ;
    function listener3d_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (listener3d_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    function listener3d_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          listener3d_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function listener3d_toPropertyKey(arg) {
      var key = listener3d_toPrimitive(arg, "string");
      return listener3d_typeof(key) === "symbol" ? key : String(key);
    }
    function listener3d_toPrimitive(input, hint) {
      if (listener3d_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (listener3d_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function panner3d_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          panner3d_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function panner3d_toPropertyKey(arg) {
      var key = panner3d_toPrimitive(arg, "string");
      return panner3d_typeof(key) === "symbol" ? key : String(key);
    }
    function panner3d_toPrimitive(input, hint) {
      if (panner3d_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (panner3d_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function panner3d_get() {
      if (typeof Reflect !== "undefined" && Reflect.get) {
        panner3d_get = Reflect.get.bind();
      } else {
      ...
      return panner3d_get.apply(this, arguments);
    }
    ...
    function panner3d_setPrototypeOf(o, p) {
      panner3d_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function panner3d_createSuper(Derived) {
      var hasNativeReflectConstruct = panner3d_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = panner3d_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = panner3d_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return panner3d_possibleConstructorReturn(this, result);
      };
    }
    ...
    function panner3d_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function delay_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          delay_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function delay_toPropertyKey(arg) {
      var key = delay_toPrimitive(arg, "string");
      return delay_typeof(key) === "symbol" ? key : String(key);
    }
    function delay_toPrimitive(input, hint) {
      if (delay_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (delay_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function delay_get() {
      ...
      return delay_get.apply(this, arguments);
    }
    ...
    function delay_setPrototypeOf(o, p) {
      delay_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function delay_createSuper(Derived) {
      var hasNativeReflectConstruct = delay_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = delay_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = delay_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return delay_possibleConstructorReturn(this, result);
      };
    }
    ...
    function delay_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function reverb_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          reverb_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function reverb_toPropertyKey(arg) {
      var key = reverb_toPrimitive(arg, "string");
      return reverb_typeof(key) === "symbol" ? key : String(key);
    }
    function reverb_toPrimitive(input, hint) {
      if (reverb_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (reverb_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function reverb_get() {
      ...
      return reverb_get.apply(this, arguments);
    }
    ...
    function reverb_setPrototypeOf(o, p) {
      reverb_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function reverb_createSuper(Derived) {
      var hasNativeReflectConstruct = reverb_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = reverb_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = reverb_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return reverb_possibleConstructorReturn(this, result);
      };
    }
    ...
    function reverb_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function metro_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          metro_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function metro_toPropertyKey(arg) {
      var key = metro_toPrimitive(arg, "string");
      return metro_typeof(key) === "symbol" ? key : String(key);
    }
    function metro_toPrimitive(input, hint) {
      if (metro_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (metro_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function looper_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          looper_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function looper_toPropertyKey(arg) {
      var key = looper_toPrimitive(arg, "string");
      return looper_typeof(key) === "symbol" ? key : String(key);
    }
    function looper_toPrimitive(input, hint) {
      if (looper_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (looper_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function soundLoop_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          soundLoop_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function soundLoop_toPropertyKey(arg) {
      var key = soundLoop_toPrimitive(arg, "string");
      return soundLoop_typeof(key) === "symbol" ? key : String(key);
    }
    function soundLoop_toPrimitive(input, hint) {
      if (soundLoop_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (soundLoop_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function compressor_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          compressor_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function compressor_toPropertyKey(arg) {
      var key = compressor_toPrimitive(arg, "string");
      return compressor_typeof(key) === "symbol" ? key : String(key);
    }
    function compressor_toPrimitive(input, hint) {
      if (compressor_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (compressor_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function compressor_get() {
      if (typeof Reflect !== "undefined" && Reflect.get) {
        compressor_get = Reflect.get.bind();
      } else {
      ...
      return compressor_get.apply(this, arguments);
    }
    ...
    function compressor_setPrototypeOf(o, p) {
      compressor_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function compressor_createSuper(Derived) {
      var hasNativeReflectConstruct = compressor_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = compressor_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = compressor_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return compressor_possibleConstructorReturn(this, result);
      };
    }
    ...
    function compressor_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function peakDetect_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (peakDetect_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    function peakDetect_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          peakDetect_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function peakDetect_toPropertyKey(arg) {
      var key = peakDetect_toPrimitive(arg, "string");
      return peakDetect_typeof(key) === "symbol" ? key : String(key);
    }
    function peakDetect_toPrimitive(input, hint) {
      if (peakDetect_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (peakDetect_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function soundRecorder_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (soundRecorder_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
    ...
    function soundRecorder_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          soundRecorder_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function soundRecorder_toPropertyKey(arg) {
      var key = soundRecorder_toPrimitive(arg, "string");
      return soundRecorder_typeof(key) === "symbol" ? key : String(key);
    }
    function soundRecorder_toPrimitive(input, hint) {
      if (soundRecorder_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (soundRecorder_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function distortion_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          distortion_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function distortion_toPropertyKey(arg) {
      var key = distortion_toPrimitive(arg, "string");
      return distortion_typeof(key) === "symbol" ? key : String(key);
    }
    function distortion_toPrimitive(input, hint) {
      if (distortion_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (distortion_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function distortion_get() {
      if (typeof Reflect !== "undefined" && Reflect.get) {
        distortion_get = Reflect.get.bind();
      } else {
      ...
      return distortion_get.apply(this, arguments);
    }
    ...
    function distortion_setPrototypeOf(o, p) {
      distortion_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function distortion_createSuper(Derived) {
      var hasNativeReflectConstruct = distortion_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = distortion_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = distortion_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return distortion_possibleConstructorReturn(this, result);
      };
    }
    ...
    function distortion_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function gain_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          gain_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function gain_toPropertyKey(arg) {
      var key = gain_toPrimitive(arg, "string");
      return gain_typeof(key) === "symbol" ? key : String(key);
    }
    function gain_toPrimitive(input, hint) {
      if (gain_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (gain_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function Env_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          Env_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function Env_createClass(Constructor, protoProps, staticProps) {
      if (protoProps) Env_defineProperties(Constructor.prototype, protoProps);
      if (staticProps) Env_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function Env_toPropertyKey(arg) {
      var key = Env_toPrimitive(arg, "string");
      return Env_typeof(key) === "symbol" ? key : String(key);
    }
    function Env_toPrimitive(input, hint) {
      if (Env_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (Env_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function Env_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function Env_inherits(subClass, superClass) {
      if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError(
          "Super expression must either be null or a function"
        );
      ...
      Object.defineProperty(subClass, "prototype", { writable: false });
      if (superClass) Env_setPrototypeOf(subClass, superClass);
    }
    function Env_setPrototypeOf(o, p) {
      Env_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
          };
      return Env_setPrototypeOf(o, p);
    }
    function Env_createSuper(Derived) {
      var hasNativeReflectConstruct = Env_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = Env_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = Env_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return Env_possibleConstructorReturn(this, result);
      };
    }
    function Env_possibleConstructorReturn(self, call) {
      if (
        call &&
        (Env_typeof(call) === "object" || typeof call === "function")
      ) {
        return call;
      } else if (call !== void 0) {
        throw new TypeError(
      ...
      return Env_assertThisInitialized(self);
    }
    function Env_assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError(
          "this hasn't been initialised - super() hasn't been called"
        );
    ...
    function Env_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function Env_getPrototypeOf(o) {
      Env_getPrototypeOf = Object.setPrototypeOf
        ? Object.getPrototypeOf.bind()
        : function _getPrototypeOf(o) {
            return o.__proto__ || Object.getPrototypeOf(o);
          };
      return Env_getPrototypeOf(o);
    }
    ...
    function audioVoice_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (audioVoice_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    function audioVoice_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          audioVoice_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function audioVoice_toPropertyKey(arg) {
      var key = audioVoice_toPrimitive(arg, "string");
      return audioVoice_typeof(key) === "symbol" ? key : String(key);
    }
    function audioVoice_toPrimitive(input, hint) {
      if (audioVoice_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (audioVoice_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function monosynth_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          monosynth_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function monosynth_toPropertyKey(arg) {
      var key = monosynth_toPrimitive(arg, "string");
      return monosynth_typeof(key) === "symbol" ? key : String(key);
    }
    function monosynth_toPrimitive(input, hint) {
      if (monosynth_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (monosynth_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function monosynth_get() {
      if (typeof Reflect !== "undefined" && Reflect.get) {
        monosynth_get = Reflect.get.bind();
      } else {
      ...
      return monosynth_get.apply(this, arguments);
    }
    ...
    function monosynth_setPrototypeOf(o, p) {
      monosynth_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
    ...
    function monosynth_createSuper(Derived) {
      var hasNativeReflectConstruct = monosynth_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = monosynth_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = monosynth_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return monosynth_possibleConstructorReturn(this, result);
      };
    }
    ...
    function monosynth_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function onsetDetect_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (onsetDetect_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    function onsetDetect_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          onsetDetect_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function onsetDetect_toPropertyKey(arg) {
      var key = onsetDetect_toPrimitive(arg, "string");
      return onsetDetect_typeof(key) === "symbol" ? key : String(key);
    }
    function onsetDetect_toPrimitive(input, hint) {
      if (onsetDetect_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (onsetDetect_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function polysynth_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          polysynth_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    ...
    function polysynth_toPropertyKey(arg) {
      var key = polysynth_toPrimitive(arg, "string");
      return polysynth_typeof(key) === "symbol" ? key : String(key);
    }
    function polysynth_toPrimitive(input, hint) {
      if (polysynth_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (polysynth_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function Signal_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          Signal_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function Signal_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        Signal_defineProperties(Constructor.prototype, protoProps);
      if (staticProps) Signal_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function Signal_toPropertyKey(arg) {
      var key = Signal_toPrimitive(arg, "string");
      return Signal_typeof(key) === "symbol" ? key : String(key);
    }
    function Signal_toPrimitive(input, hint) {
      if (Signal_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (Signal_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
